<template>
  <div class="navbar bg-white border-b-primary border-b-4">
    <div class="navbar-start">
      ...
      <a class="btn btn-ghost text-xl hover:bg-base-200" href="/"><img width="120" src="../../public/icon.png" alt="logo" /></a>
    </div>
